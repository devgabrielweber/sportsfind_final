<header class="bg-neutral-750">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 border-b-8 border-green-600"
        aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            ...
            <a href="{{ route('documento.list') }}"
                class="text-xl font-semibold leading-6 text-gray-200">Carteirinha</a>
